...
CODEGEN_FILES = $(wildcard codegen/*.elm) $(wildcard codegen/Glsl/*.elm) $(wildcard codegen/helpers/*.elm)
...
generated/Glsl/Functions.elm: codegen/functions.frag $(CODEGEN_FILES) Makefile
	rm -rf generated

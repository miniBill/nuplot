...
class MeplotDraw {
	...
	private final class DrawOGL extends AbstractGraphics {
		...
		public void setColor(final int color) {
			...
			this.color = new Vector3D(rcomp / 255.0f, gcomp / 255.0f, bcomp / 255.0f);
		}
	...
	public void genGraph(final OpenGL3D draw, final String[] stringa, final int[] colore, final int width,
			final int height) {
		final DrawController dc = new DrawController();
		final DrawOGL graphics = new DrawOGL(draw);
		final List<Graph> gl = new List<Graph>();

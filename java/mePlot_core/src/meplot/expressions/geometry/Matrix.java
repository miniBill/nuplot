...
public class Matrix extends Tensor{
	...
	public Matrix(final IExpressionList exprList, final boolean isVector){
		...
		final IExpressionIterator iterator = exprList.getIterator();
	...
	private void fillByList(final IExpressionIterator iterator){
	...
	public final IExpressionIterator getElements(){

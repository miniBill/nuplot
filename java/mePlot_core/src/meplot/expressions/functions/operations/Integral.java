...
public final class Integral extends Function {
	...
	public Integral(final Expression function, final Expression differential, final Expression lower,
			final Expression upper) {
		super(new Expression[] { function, differential, lower, upper }, new boolean[] { true, true, false, false });
	}
	...
	private static Expression integrate(final Expression function, final Letter differential, final Expression lower,
			final Expression upper) {

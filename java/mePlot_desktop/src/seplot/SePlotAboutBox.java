...
public class SePlotAboutBox extends javax.swing.JDialog{

	/**
	 *
	 */
	private static final long serialVersionUID = 3893649585449831906L;

	public SePlotAboutBox(final java.awt.Frame parent){
		super(parent);
		initComponents();
	...
	private void initComponents(){
		...
		final org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getResourceMap(SePlotAboutBox.class);
		...
		final javax.swing.ActionMap actionMap = org.jdesktop.application.Application
				.getInstance(seplot.SePlotApp.class).getContext()
				.getActionMap(SePlotAboutBox.class, this);

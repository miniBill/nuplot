...
export class NuPlot extends HTMLElement {
    ...
    constructor() {
        ...
        /** @type {{ [pointerId: number]: Point }} */
        this.pointers = this.originalPointers = {};
    ...
    /**
     * @param {boolean} changeSize
     * @param {() => void} callback
     */
    withFilledCanvas(changeSize, callback) {
        let oldWidth = 0;
        let oldHeight = 0;
        ...
        if (changeSize) {
            ...
            const heightString = window.prompt(
     ...
     */
    compileAndAttachShader(type, src) {
     ...
     * @returns number
     */
    static project(x, froml, fromu, tol, tou) {
    ...
    canvasOnWheel(e) {
        ...
        this.center = {
            x:
                ...
                this.viewportWidth *
                    (1 - k) *
                    (e.offsetX / this.canvas.width - 0.5),
            y:
                this.center.y +
                this.viewportHeight *
                    (1 - k) *
                    (0.5 - e.offsetY / this.canvas.height),
        };
    ...
    canvasOnPointerMove(e) {
        ...
        switch (Object.keys(this.originalPointers).length) {
            ...
            case 2:
                ...
                this.viewportWidth =
                    (this.originalViewportWidth /
                        NuPlot.distance(pointer, other)) *
   ...
   */
     ...
     */
    renderOnAnimationFrame(rightNow = false) {
    ...
    reloadFragmentShader() {
        if (!this.gl || !this.program || !this.fragment_shader || !this.src)
            return;
...
${built}`;
        ...
        const compiled = this.gl.getShaderParameter(
            shader,

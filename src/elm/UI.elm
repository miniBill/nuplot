            ...
            :: (if String.isEmpty value then
                    ...
                    case parsed of
                        ...
                        Ok expr ->
                            ...
                            in
                            [ text <| "Interpreted as: " ++ Expression.toString expr, Element.Keyed.el [ centerX ] ( value, draw graph ) ]
               )
...
implicit2d : Float -> List Float -> List Float -> Expression -> Expression -> List (Svg.Svg msg)
implicit2d scale xrange yrange l r =
    case yrange of
        [] ->
            []

module OperationActivator exposing (activateOperations)

import TokenList exposing (TokenList)


activateOperations : TokenList -> TokenList
activateOperations =
    Debug.todo "activateOperations"

module TokenList exposing (TokenIterator, TokenList, getIterator, hasNext, toExpression)
...
toExpression_ index tokenList =
    Debug.todo "toExpression_"


getIterator : TokenList -> TokenIterator
getIterator =
    TokenIterator


hasNext : TokenIterator -> Bool
hasNext =
    0
